...
const GISCUS_REPOSITORY = "rlaguswls13/giscus-blog";
const OUTPUT_PATH = path.join(process.cwd(), "src", "data", "engagement.json");
...
async function main() {
  ...
  try {
    ...
    for (const discussion of discussions) {
      const pathname = discussionPathname(discussion);
