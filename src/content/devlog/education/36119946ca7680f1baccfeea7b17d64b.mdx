...
<NotionToggle title="문제풀이 _1" level="1">


<NotionToggle title="구구단" level="3">
...
<NotionToggle title="영수증 계산기" level="3">
...
<NotionToggle title="A+B 출력" level="3">
...
<NotionToggle title="문제풀이_2" level="1">


<NotionToggle title="7의 배수 찾기" level="3">
...
<NotionToggle title="누적합 종료 조건" level="3">
...
<NotionToggle title="짝수만 제곱하여 출력" level="3">
...
<NotionToggle title="별 피라미드 출력" level="3">
