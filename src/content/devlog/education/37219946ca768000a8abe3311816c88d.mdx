...
<NotionToggle title="네트워크 (java / OSI 7계층)" level="3">


<NotionToggle title="1. 네트워크의 일반적인 정의" level="3">
...
<NotionToggle title="2. OSI 7계층과 Java 애플리케이션의 관계" level="3">


<NotionToggle title="(1) OSI 7계층" level="3">
...
<NotionToggle title="(2) Java(Application) 단과 연관이 깊은 계층" level="3">
...
<NotionToggle title=" 3. 계층별 Java 구현 예시 코드" level="3">
...
<NotionToggle title="4. 백엔드 개발자 관점에서 바라보는 네트워크 기능 활용" level="2">
...
<NotionToggle title="(1) 추상화 장벽 허물기: 고수준 API 이면의 저수준 동작 이해" level="3">
...
<NotionToggle title="(2) 서비스 요구사항에 따른 전송 방식 선택" level="3">
...
<NotionToggle title="(3) 비동기 및 논블로킹 I/O 모델의 이해" level="3">
