...
<NotionToggle title="1. 상수(Constant)와 명명 규칙" level="2">

Java에서 상수는 `final` 키워드를 사용하여 선언하며, 한 번 할당된 값은 변경할 수 없습니다.


<NotionToggle title="명명법 예시 코드" level="3">
...
<NotionToggle title="2. 형변환(Type Casting)과 예외 처리" level="2">
...
<NotionToggle title="형변환 및 예외 처리 예시" level="3">
...
<NotionToggle title="지정/자동 vs 업/다운 형변환 (casting) 용어의 차이" level="3">
...
<NotionToggle title="3. Java 메모리 구조 시각화" level="2">

<NotionImage src="/images/notion/35f19946-ca76-8083-b34b-dc26c2f64270.png" caption="image" />
...
<NotionToggle title="4. 통합 실습 예제: 연산기 및 예외 방어 로직" level="2">
...
<NotionToggle title="5. 요약 및 핵심 포인트" level="2">
