...
<NotionToggle title="1. 자바스크립트에서 배열과 자바에서의 배열의 차이점" level="2">
...
<NotionToggle title="1. 단일 타입(밀집)에서 믹스 타입(희소)으로 변환되는 예시" level="3">
...
<NotionToggle title="2. 빈 공간(Hole)이 생겨 희소 배열로 변환되는 예시" level="3">
...
<NotionToggle title="3. 극단적인 희소 배열: 딕셔너리 모드 (Dictionary Mode)" level="3">
...
<NotionToggle title="2. 자바스크립트의 자료구조 및 예시" level="2">

자바스크립트에서 기본으로 제공하거나 구현하여 사용하는 대표적인 자료구조들입니다.


<NotionToggle title="1) 배열 (Array)" level="3">
...
<NotionToggle title="2) 객체 (Object)" level="3">
...
<NotionToggle title="3) 맵 (Map)" level="3">
...
<NotionToggle title="4) 셋 (Set)" level="3">
...
<NotionToggle title="5) 스택 / 큐 (Stack / Queue)" level="3">
...
<NotionToggle title="3. 구조분해 (Destructuring) 자료구조 활용 및 예시" level="2">

구조분해 할당은 배열이나 객체의 속성을 해체하여 그 값을 개별 변수에 맞춤형으로 담을 수 있게 하는 자바스크립트의 표현식입니다.


<NotionToggle title="1) 배열 구조분해 할당" level="3">
...
<NotionToggle title="2) 객체 구조분해 할당" level="3">
...
<NotionToggle title="4. 스프레드(Spread)와 구조분해(Destructuring) 차이점" level="2">
...
<NotionToggle title="5. 고차 함수 (Higher-Order Function) 사용법 및 예시" level="2">
...
<NotionToggle title="추가보충 1) 콜백 함수 (Callback Function)" level="2">
...
<NotionToggle title="1. 동기적 콜백 (Synchronous Callback)" level="3">
...
<NotionToggle title="2. 비동기적 콜백 (Asynchronous Callback)" level="3">
...
<NotionToggle title="3. 보충: 콜백 함수의 문제점 (콜백 지옥)" level="3">
...
<NotionToggle title="추가보충 2) 프로미스 (Promise) 활용법" level="2">
...
<NotionToggle title="프로미스 생성 및 기본 소비 예시" level="3">
...
<NotionToggle title="프로미스 체이닝 (Promise Chaining)" level="3">
...
<NotionToggle title="추가보충 3) async / await 활용법" level="2">
...
<NotionToggle title="3. 보충: 진화 과정 비교 (콜백 vs 프로미스 vs async/await)" level="2">
