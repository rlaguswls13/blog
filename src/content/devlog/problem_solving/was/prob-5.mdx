...
date: "2026.05.26"
tags: ["Troubleshooting", "WAS", "Tomcat", "Session", "Clustering", "JWT", "Redis", "LoadBalance", "SpringBoot"]
...
<Collapsible title="1. Apache + Tomcat (mod_jk) 스티키 세션 설정 예시">
<Indent>
...
<Collapsible title="2. Nginx 스티키 세션 설정 예시">
<Indent>
...
<Collapsible title="Tomcat Cluster 설정 예시">
<Indent>
...
<Collapsible title="Spring Session + Redis 설정 예시">
<Indent>
...
<Collapsible title="JWT 필터 설정 예시">
<Indent>
