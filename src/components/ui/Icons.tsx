...
export function CalendarIcon({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg
            ...
            className={className}
            style={{ display: 'inline-block', verticalAlign: 'text-bottom', marginRight: '6px', ...style }}
        >
...
export function BlogIcon({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
...
export function CommentIcon({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
