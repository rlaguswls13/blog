      ...
      <DiagramBody>
        <TwoColumnGrid>
          <div>
            ...
            <FlowCard theme="fuchsia" variant="soft" title="RDBMS Recursive Modeling" desc="재귀 쿼리 기반 조직도 계층 구조 설계" />
            <Arrow />
            <FlowCard theme="fuchsia" variant="solid" title="Denormalization Strategy" desc="역정규화 기법으로 대규모 조회 성능 최적화" />
            <Arrow />
            <FlowCard theme="slate" variant="dark" title="Local Cache Layer" desc="Guava Cache 기반 조직 데이터 캐싱" />
          </div>
          <div>
            <SectionTitle icon={<Icons.Users />} label="B2B 권한 & 포털 기능" theme="blue" />
            <FlowCard theme="blue" variant="soft" title="Multi-Tenant Auth" desc="고객사별 독립적 권한 체계 구현" />
            <Arrow />
